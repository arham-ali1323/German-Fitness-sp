...
>
        ...
        <button 
          ...
          className="fixed bottom-8 right-8 bg-orange-600 hover:bg-orange-700 text-white p-3 rounded border border-gray-700 transition-all duration-300 transform hover:scale-110"
