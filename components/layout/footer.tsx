      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="flex items-center md:col-span-5 pr-6 border-r border-gray-800">
            <div className="space-y-4">
              ...
              <div className="flex gap-1">
                <span className="text-orange-500 text-2xl font-bold tracking-widest animate-pulse">
                  Core strength
                </span>
              </div>
            </div>
          ...
          <div className="space-y-6 md:col-span-4 px-6 border-r border-gray-800">
            ...
            <div className="space-y-3">
              <div className="border-b border-gray-800 pb-3">
                <p className="text-orange-500 text-xs font-semibold tracking-wider mb-1">
                  CALL US ANYTIME
                </p>
                <a
                  href="tel:+1234567345"
        ...
        <div className="mt-16 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            {/* Center - Social Icons */}
            <div className="flex items-center gap-3 border-r border-gray-800 px-6">
              <a
                href="#"
                className="w-10 h-10 bg-gray-900 hover:bg-orange-500 flex items-center justify-center transition"
              >
                {/* Facebook Icon */}
                <svg
                  className="w-4 h-4"
            ...
            <div className="flex items-center gap-6 px-6">
              <a
                href="#"
                className="text-gray-500 hover:text-orange-500 text-xs transition"
              >
                Privacy Policy
              </a>
              <a
