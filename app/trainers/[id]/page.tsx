...
export default function TrainerProfilePage() {
  ...
  const workExperience = trainer.workExperience;
              ...
              <div className="p-8">
                ...
                <div className="flex gap-3 mb-8">
                  {socialLinks.map((social, index) => (
                    <a
                      ...
                      className="bg-gray-800 hover:bg-orange-600 p-3 transition-colors duration-300"
                    >
                ...
                <div className="space-y-4">
                  <a
                    ...
                    className="block text-2xl font-bold text-orange-600 hover:text-orange-700 transition-colors duration-300"
                  >
                    {trainer.phone}
                  </a>
                  <a
                    href={`mailto:${trainer.email}`}
                    className="block text-lg text-gray-300 hover:text-orange-600 transition-colors duration-300"
                  >
                    {trainer.email}
                  </a>
                </div>
              ...
              <div className="space-y-6">
                {certifications.map((cert) => (
                  <div key={cert.number} className="flex gap-4">
                    <div className="flex-shrink-0 w-12 h-12 bg-gray-800 border-2 border-gray-700 rounded-full flex items-center justify-center">
                      <span className="text-xl font-bold">{cert.number}</span>
                    </div>
                    <div>
